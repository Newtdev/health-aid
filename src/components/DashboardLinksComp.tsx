...
const DashboardLinkesComp = ({ name, links }: LinksType) => {
    ...
    return <li>
        <NavLink to={links} className={`flex  ${a} items-center px-2 py-6 text-gray-100 rounded-lg dark:text-white hover:bg-gray-100  group`}>
